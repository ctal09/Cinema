...
export default function MovieTable1() {
    ...
    return (
        <div className="container mt-4">
            <h2 className="text-center mb-4">Other Movie List</h2>
                        ...
                        {movies.map((movie) => (
                            <tr key={movie.id}>
                                ...
                                <td>
                                    ...
                                    <button
                                        onClick={() => handleDelete(movie.Item, "others")}
            ...
            <EditMovieModal
                ...
                section="others" // or "others" for other table
            />
        </div >
    );
}